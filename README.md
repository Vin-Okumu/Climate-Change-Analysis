...
The dataset used herein can be used for machine learning models, statistical analysis, and clinical decision-making to enhance early detection and personalized treatment strategies for DED. 
It can also be used to predict another severe sleep-related disease such as insomnia which can be directly linked with ocular surface diseases (OSD).
